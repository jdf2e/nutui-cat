import { SvelteComponent, init, safe_not_equal, append_styles, svg_element, attr, null_to_empty, insert, append, detach, empty, noop } from 'svelte/internal';
...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			attr(svg, "class", svg_class_value = "" + (null_to_empty(/*c*/ ctx[9]) + " svelte-1cj2gr0"));
			attr(svg, "style", /*s*/ ctx[8]);
		...
		p(ctx, dirty) {
			...
			if (dirty & /*c*/ 512 && svg_class_value !== (svg_class_value = "" + (null_to_empty(/*c*/ ctx[9]) + " svelte-1cj2gr0"))) {
