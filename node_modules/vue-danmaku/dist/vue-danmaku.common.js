...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"8f5617da-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/lib/main.vue?vue&type=template&id=9a45f322&
...
// CONCATENATED MODULE: ./src/lib/main.vue?vue&type=template&id=9a45f322&
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  watch: {
    danmus: {
      handler: function handler(val) {
        this.danmuList = _toConsumableArray(val);
      },
      deep: true
    }
  },
  ...
  methods: {
    ...
    initConfig: function initConfig() {
      ...
      this.danmaku = _objectSpread(_objectSpread({}, this.danmaku), {}, {
      ...
      this.danmu = _objectSpread(_objectSpread({}, this.danmu), {}, {
        speeds: this.speeds,
    ...
    insert: function insert() {
      ...
      this.$nextTick(function () {
        if (!_this2.danmu.height || !_this2.danmaku.channels) {
          _this2.danmu.height = el.offsetHeight; // 如果没有设置轨道数，则在获取到所有高度后计算出最大轨道数

          if (!_this2.danmaku.channels) {
            _this2.danmaku.channels = Math.floor(_this2.container.height / _this2.danmu.height);
          }
        }

        var channelIndex = _this2.getChannelIndex(el);

        if (channelIndex >= 0) {
          var width = el.offsetWidth;
          var height = _this2.danmu.height;
          el.classList.add('move'); // 匀速
          // const speeds = (this.container.width + width) / this.danmu.speeds

          var speeds = _this2.container.width / _this2.danmu.speeds;
          el.style.animationDuration = "".concat(speeds, "s");
          el.style.top = channelIndex * (height + _this2.danmu.top) + 'px';
          el.style.width = width + _this2.danmu.right + 'px';
          el.style.setProperty('--dm-left-offset', "-".concat(_this2.container.width, "px"));
          el.dataset.index = _this2.index;
          el.addEventListener('animationend', function () {
            _this2.$dmContainer.removeChild(el);
          });
    ...
    getChannelIndex: function getChannelIndex(el) {
      ...
      try {
        var _loop = function _loop() {
          var i = _step.value;
          var items = _this3.danChannel[i];

          if (items && items.length) {
            for (var j = 0; j < items.length; j++) {
              var danRight = _this3.getDanRight(items[j]) - 10; // 安全距离判断
              ...
              if (j === items.length - 1) {
                _this3.danChannel[i].push(el);

                el.addEventListener('animationend', function () {
                  return _this3.danChannel[i].splice(0, 1);
                });
                return {
                  v: i % _this3.danmaku.channels
                };
              }
            }
          } else {
            _this3.danChannel[i] = [el];
            el.addEventListener('animationend', function () {
              return _this3.danChannel[i].splice(0, 1);
            });
            return {
    ...
    setChannels: function setChannels(len) {
