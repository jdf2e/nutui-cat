<template>
  <div class="demo">
    ...
    <!-- <nut-cell>
      ...
      <span slot="desc">
        <NutButton radius bgColor="#E8220E" beforeIcon="arrow-normal">商品名称</NutButton>
      </span>
    </nut-cell> -->
    <nut-cell>
      <span slot="title">自定义图标</span>
...
.nutcat-button-rank-1 {
  margin-left: 10px;
}
.nutcat-button-rank-2 {
  margin-left: 10px;
}
</style>
